...
INSERT INTO script_options
  ...
  VALUES
    ('for', 'true', 'a statement that repeats a set number of times'),
...
INSERT INTO command_options
  ...
  VALUES
  ('echo', 'this command prints the text of a file to the bash terminal, youll need to specify the path of a file to use it (see below on how to find filepaths)', 'true'),
  ('touch', 'this allows you to create a file in whatever folder you''re currently in youll need to enter a filename after this. (move into the folder you want with cd', 'true'),
